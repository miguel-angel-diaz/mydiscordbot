...
CHALLONGE_USERNAME = os.getenv("CHALLONGEUSERNAME")
CHALLONGE_API_KEY = os.getenv("CHALLONGEAPIKEY")

print("🔍 DEBUG: CHALLONGE_USERNAME =", CHALLONGEUSERNAME)
print("🔍 DEBUG: CHALLONGE_API_KEY =", "✅ Cargada" if CHALLONGEAPIKEY else "❌ Vacía")
